 ...
 * Size: 84 px
 * Bpp: 4
 * Opts: --font src/IBMPlexSans-Bold.ttf --size 84 --bpp 4 --format lvgl --no-compress --range 0x30-0x39,0x20,0x3A -o plex_num_84.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 806, .box_w = 46, .box_h = 61, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 1403, .adv_w = 806, .box_w = 47, .box_h = 59, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 2790, .adv_w = 806, .box_w = 44, .box_h = 60, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 4110, .adv_w = 806, .box_w = 45, .box_h = 61, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 5483, .adv_w = 806, .box_w = 46, .box_h = 58, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 6817, .adv_w = 806, .box_w = 45, .box_h = 59, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 8145, .adv_w = 806, .box_w = 45, .box_h = 60, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 9495, .adv_w = 806, .box_w = 43, .box_h = 60, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 10785, .adv_w = 806, .box_w = 45, .box_h = 61, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 12158, .adv_w = 806, .box_w = 45, .box_h = 60, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 13508, .adv_w = 444, .box_w = 16, .box_h = 46, .ofs_x = 6, .ofs_y = -1}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t plex_num_84 = {
#else
lv_font_t plex_num_84 = {
#endif
