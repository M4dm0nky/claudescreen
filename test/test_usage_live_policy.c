...
int main(void) {
  ...
  check_header("four effective jobs report the exact active count",
               &four_active_jobs, 0, false, true, "4 AGENTS", true);
